...
public class Address {
    ...
    @NotBlank
    @Size(min = 5, max = 50, message = "Street name must be at least between 5 to 50 characters")
    private String street;

    @NotBlank
    @Size(min = 5, max = 50, message = "Building name must be at least between 5 to 50 characters")
